...
namespace PostApiService.Tests.IntegrationTests.Controllers
{
    ...
    public class AdminPostsControllerTests
    {
        ...
        public AdminPostsControllerTests(ServiceTestFixture fixture)
        {
            _fixture = fixture;
        ...
        public async Task GetAdminPostsAsync_ShouldReturnAllPostsForAuthenticatedAdmin()
        {
            ...
            var posts = TestDataHelper.GetPostsWithComments(count: TotalCount, categories, authorIds: authorIds);
        ...
        public async Task DeletePostAsync_ShouldRemovePostAndAssociatedComments_Cascade()
        {
            ...
            string[] authorIds = new[] { TestUserData.AdminId, TestUserData.ContributorId };
            var posts = TestDataHelper.GetPostsWithComments(count: 1, categories, authorIds: authorIds, commentCount: 3);
