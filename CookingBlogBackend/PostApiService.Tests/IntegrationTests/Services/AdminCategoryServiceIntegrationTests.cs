...
namespace PostApiService.Tests.IntegrationTests.Services
{
    ...
    public class AdminCategoryServiceIntegrationTests
    {
        private readonly ServiceTestFixture _fixture;

        public AdminCategoryServiceIntegrationTests(ServiceTestFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task AddCategoryAsync_ShouldSaveCategoryInDatabase_WhenDataIsValid()
        {
            ...
            var (_, dbContextAssert, _) = _fixture.GetScopedService<IAdminCategoryService>();
