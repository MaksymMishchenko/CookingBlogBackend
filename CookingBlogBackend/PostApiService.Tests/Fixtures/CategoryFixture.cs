...
{
    public class CategoryFixture : BaseTestFixture
    {
        private const string _identityConnectionString = $"Server=MAX\\SQLEXPRESS;Database=CategoryIdentityTestDb;" +
           "Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True;";
        private const string _connectionString = "Server=MAX\\SQLEXPRESS;Database=TestCategory;Trusted_Connection=True;" +
            "MultipleActiveResultSets=True;TrustServerCertificate=True;";

        public CategoryFixture() : base(_connectionString, _identityConnectionString, useDatabase: true) { }
